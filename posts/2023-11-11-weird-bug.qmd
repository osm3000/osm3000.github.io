...
description: A multiprocessing freeze traced back to how Python pickles classes and worker state.
categories:
- thinking
tags:
- programming
aliases:
- /thinking/2023/11/11/weird-bug.html
- /2023/11/11/weird-bug.html
---
# Context
