...
description: I benchmarked SoA vs AoS in Python. While SoA was more efficient than
  AoS, its readability penalty outweighed the gains.
tags:
- projects
aliases:
- /2025/11/23/structofarrays-vs-arrayofstructs-in-python.html
---
